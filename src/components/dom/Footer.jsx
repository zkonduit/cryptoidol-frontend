export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 z-20 w-full p-3 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6">
      <ul className="flex flex-wrap items-center mt-2 text-lg font-medium text-gray-800 sm:mt-0">
        <li>
